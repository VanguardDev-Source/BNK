return {
	Weapons = {
		...
		['WEAPON_ADVANCEDRIFLE'] = {
			...
			durability = 1.5,
			ammoname = 'ammo-rifle',
			description = "Compatible with Extended Rifle Clip, Tactical Suppressor, Tactical Flashlight",
		},
		...
		['WEAPON_APPISTOL'] = {
			...
			durability = 1.5,
			ammoname = 'ammo-9',
			description = "Compatible with Extended Pistol Clip, Suppressor, Tactical Flashlight",
		},
		...
		['WEAPON_ASSAULTRIFLE'] = {
			...
			description = "Compatible with Extended Rifle Clip, Grip, Tactical Suppressor, Tactical Flashlight",
		},
		...
		['WEAPON_ASSAULTSMG'] = {
			...
			durability = 1.5,
			ammoname = 'ammo-rifle',
			description = "Compatible with Extended SMG Clip, Grip, Suppressor, Tactical Flashlight",
		},
		...
		['WEAPON_CERAMICPISTOL'] = {
			label = 'PD-Ceramic Pistol',
			weight = 800,
			durability = 1.5,
			ammoname = 'ammo-9',
			description = "Compatible with Extended Pistol Clip, Suppressor",
		},
		...
		['WEAPON_PISTOLXM3'] = {
			...
			durability = 1.5,
			ammoname = 'ammo-9',
			description = "Compatible with Suppressor",
		},
		...
		['WEAPON_COMPACTRIFLE'] = {
			...
			durability = 1.5,
			ammoname = 'ammo-rifle2',
			description = "Compatible with Extended Rifle Clip",
		},
		...
		['WEAPON_GUSENBERG'] = {
			...
			durability = 1.5,
			ammoname = 'ammo-45',
			description = "Compatible with Extended Rifle Clip, Extended MG Clip",
		},
		...
		['WEAPON_HEAVYPISTOL'] = {
			...
			durability = 1.5,
			ammoname = 'ammo-45',
			description = "Compatible with Extended Pistol Clip, Tactical Flashlight, Suppressor",
		},
		...
		['WEAPON_MACHINEPISTOL'] = {
			...
			durability = 1.5,
			ammoname = 'ammo-9',
			description = "Compatible with Extended Pistol Clip, Extended SMG Clip, Suppressor",
		},
		...
		['WEAPON_MICROSMG'] = {
			...
			durability = 1.5,
			ammoname = 'ammo-45',
			description = "Compatible with Extended SMG Clip, Tactical Suppressor, Tactical Flashlight",
		},
		...
		['WEAPON_MILITARYRIFLE'] = {
			...
			durability = 1.5,
			ammoname = 'ammo-rifle',
			description = "Compatible with Extended Rifle Clip, Tactical Flashlight, Tactical Suppressor",
		},
		...
		['WEAPON_MINISMG'] = {
			...
			durability = 1.5,
			ammoname = 'ammo-9',
			description = "Compatible with Extended SMG Clip",
		},
		...
		['WEAPON_MUSKET'] = {
			...
			description = "No compatible attachments",
			job = {['police'] = 0, ['sheriff'] = 0}
		},
		...
		['WEAPON_PISTOL50'] = {
			...
			durability = 1.5,
			ammoname = 'ammo-50',
			description = "Compatible with Tactical Suppressor, Extended Pistol Clip, Tactical Flashlight",
		},
		...
		['WEAPON_PUMPSHOTGUN'] = {
			...
			durability = 1.5,
			ammoname = 'ammo-shotgun',
			description = "Compatible with Tactical Flashlight, Tactical Suppressor",
		},

		['WEAPON_PUMPSHOTGUN_MK2'] = {
			label = 'PD-Pump Shotgun MK2',
			weight = 3200,
			durability = 1.5,
			ammoname = 'ammo-shotgun',
			description = "Compatible with Tactical Suppressor, Tactical Flashlight"
		},
		...
		['WEAPON_SMG_MK2'] = {
			...
			durability = 0.07,
			ammoname = 'ammo-9',
			description = "Compatible with Extended SMG Clip, Suppressor, Tactical Flashlight",
		},
		...
		['WEAPON_SNSPISTOL'] = {
			...
			durability = 1.5,
			ammoname = 'ammo-9',
			description = "Compatible with Extended Pistol Clip",
		},

		['WEAPON_SNSPISTOL_MK2'] = {
			label = 'PD-SNS Pistol MK2',
			weight = 465,
			durability = 1.5,
			ammoname = 'ammo-45',
			description = "Compatible with Extended Pistol Clip, Suppressor, Tactical Flashlight",
		...
		['WEAPON_TACTICALRIFLE'] = {
			...
			durability = 1.5,
			ammoname = 'ammo-rifle',
			description = "Compatible with Extended Rifle Clip, Tactical Flashlight, Tactical Suppressor, Grip",
		},
	...
	Components = {
		['at_flashlight'] = {
			...
			weight = 120,
			type = 'flashlight',
			description = "Compatible with: Pistol, PD-SNS Pistol MK2, PD-Combat Pistol, PD-Pistol MK2, PD-Desert Eagle, Heavy Pistol, Pump Shotgun, Micro SMG, SMG, Bullpup Rifle, Carbine Rifle, Assault Rifle, PD-Combat PDW, PD-SMG Mk2, PD-Bullpup Rifle MK2, PD-Special Carbine MK2, PD-Carbine Rifle MK2, PD-Tactical Rifle, AP Pistol, Assault SMG, Military Rifle, Advanced Rifle, PD-Assault Rifle MK2",
			client = {
				component = {
		...
		['at_suppressor_light'] = {
			...
			weight = 280,
			type = 'muzzle',
			description = "Compatible with: Pistol, PD-Ceramic Pistol, PD-Combat Pistol, PD-SNS Pistol MK2, PD-Pistol MK2, Heavy Pistol, WM 29 Pistol, AP Pistol, SMG, Machine Pistol, Assault SMG",
			client = {
				component = {
		...
		['at_suppressor_heavy'] = {
			...
			weight = 280,
			type = 'muzzle',
			description = "Compatible with: PD-Desert Eagle, PD-Pump Shotgun MK2, Pump Shotgun, Micro SMG, Bullpup Rifle, Carbine Rifle, Assault Rifle, PD-Bullpup Rifle MK2, PD-Special Carbine MK2, PD-Carbine Rifle MK2, PD-Tactical Rifle, Military Rifle, Advanced Rifle, PD-Assault Rifle MK2",
			client = {
				component = {
		...
		['at_grip'] = {
			...
			type = 'grip',
			weight = 280,
			description = "Compatible with: PD-Combat PDW, SMG, Bullpup Rifle, Carbine Rifle, Assault Rifle, PD-Tactical Rifle, Assault SMG, PD-Bullpup Rifle MK2, PD-Special Carbine MK2, PD-Carbine Rifle MK2, PD-Assault Rifle MK2",
			client = {
				component = {
		...
		['at_clip_extended_pistol'] = {
			...
			type = 'magazine',
			weight = 280,
			description = "Compatible with: Pistol, PD-Ceramic Pistol, PD-Combat Pistol, PD-SNS Pistol MK2, PD-Pistol MK2, PD-Desert Eagle, Heavy Pistol, SNS Pistol, WM 29 Pistol, AP Pistol, Machine Pistol",
			client = {
				component = {
		...
		['at_clip_extended_smg'] = {
			...
			type = 'magazine',
			weight = 280,
			description = "Compatible with: PD-Combat PDW, PD-SMG Mk2, Micro SMG, SMG, Mini SMG, Machine Pistol, Assault SMG",
			client = {
				component = {
		...
		['at_clip_extended_rifle'] = {
			...
			type = 'magazine',
			weight = 280,
			description = "Compatible with: PD-Bullpup Rifle MK2, PD-Special Carbine MK2, PD-Carbine Rifle MK2, PD-Tactical Rifle, Compact Rifle, Bullpup Rifle, Carbine Rifle, Assault Rifle, Military Rifle, Advanced Rifle, Gusenberg, PD-Assault Rifle MK2",
			client = {
				component = {
		...
		['at_clip_extended_mg'] = {
			...
			type = 'magazine',
			weight = 280,
			description = "Compatible with: Gusenberg",
			client = {
				component = {
